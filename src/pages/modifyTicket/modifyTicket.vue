<template>
    <div class="content">
        <div class="item-div">
            ...
            <div class="btn-div">
                <mt-button type="primary" class="btn" @click="doModifyTicket">修改</mt-button>
                <mt-button type="danger" class="btn" @click="doDeleteTicket">删除</mt-button>
    ...
    export default {
        ...
        data() {
            return {
                ...
                startStationName: this.$route.query.startStationName,
                startTime: this.$route.query.startTime,
                lishi: this.$route.query.lishi,
                toStationName: this.$route.query.toStationName,
                arriveTime: this.$route.query.arriveTime,
                swzNum: this.$route.query.swzNum,
                zyNum: this.$route.query.zyNum,
                zeNum: this.$route.query.zeNum,
                yzNum: this.$route.query.yzNum,
                ywNum: this.$route.query.ywNum,
                wzNum: this.$route.query.wzNum,
                swzMoney: this.$route.query.swzMoney,
                zyMoney: this.$route.query.zyMoney,
                zeMoney: this.$route.query.zeMoney,
                yzMoney: this.$route.query.yzMoney,
                ywMoney: this.$route.query.ywMoney,
                wzMoney: this.$route.query.wzMoney
            }
        },
        methods: {
            doModifyTicket: function () {
                if (this.trainCode.length === 0) {
                    ...
                    Indicator.open();
                    var params = '?trainId=' + this.trainId
                    ...
                    this.$http.get(Api.MODIFY_TICKET + params)
                        .then(res => {
                            return res.json();
                        })
                        .then(res => {
            ...
            doDeleteTicket: function () {
                Indicator.open();
                var params = '?trainId=' + this.trainId;
                this.$http.get(Api.DELETE_TICKET + params)
                    .then(res => {
                        return res.json();
                    })
                    .then(res => {
